...
build_library macosx macosx14.0 CoolWater-macos.metallib
build_library iphoneos ios17.0 CoolWater-ios.metallib
build_library iphonesimulator ios17.0-simulator CoolWater-iossim.metallib
build_library xros xros2.0 CoolWater-xros.metallib
build_library xrsimulator xros2.0-simulator CoolWater-xrossim.metallib
