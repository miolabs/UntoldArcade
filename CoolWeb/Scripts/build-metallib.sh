...
build_library macosx CoolWeb-macos.metallib
build_library iphoneos CoolWeb-ios.metallib
build_library iphonesimulator CoolWeb-iossim.metallib
build_library xros CoolWeb-xros.metallib
build_library xrsimulator CoolWeb-xrossim.metallib
