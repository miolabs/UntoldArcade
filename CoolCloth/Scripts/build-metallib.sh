...
build_library macosx macosx14.0 CoolCloth-macos.metallib
build_library iphoneos ios17.0 CoolCloth-ios.metallib
build_library iphonesimulator ios17.0-simulator CoolCloth-iossim.metallib
build_library xros xros2.0 CoolCloth-xros.metallib
build_library xrsimulator xros2.0-simulator CoolCloth-xrossim.metallib
