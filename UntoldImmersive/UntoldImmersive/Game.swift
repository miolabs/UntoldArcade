...
private func buildSceneInCode() {
    ...
    translateBy(entityId: stadium, position: simd_float3(0.0, -5.0, -30.0))
    ...
    translateBy(entityId: player, position: simd_float3(0.0, -5.0, -30.0))
    ...
    translateBy(entityId: ball, position: simd_float3(0.0, -4.6, -27.0))
